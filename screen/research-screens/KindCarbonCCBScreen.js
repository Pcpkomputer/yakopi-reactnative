...
export default function KindCarbonCCBScreen(props){
    ...
    let fetchList = async () =>{
        ...
        let request = await fetch(`${endpoint}/research/ccb/carbon`,{
            method:"POST",
            headers:{
    ...
    return (
      <View style={{flex:1, backgroundColor:'#fff'}}>
        ...
        <TouchableOpacity 
            activeOpacity={0.6}
            onPress={()=>{
                props.navigation.navigate("InputDetailCarbonCCB",{ id_ccb:props.route.params.id_ccb });
            }}
                  ...
                  Alert.alert(
                      ...
                      [
                        ...
                        { text: "Iya", onPress: async () => {
                              ...
                              let id = item.id_ccb_carbon;
                              console.log(id);
                              let request = await fetch(`${endpoint}/research/ccb/deleteCarbon`,{
                                  method:"DELETE",
                                  headers:{
                                      "authorization":`Bearer ${globalContext.credentials.token}`,
                                      "content-type":"application/json"
