...
export default function InputDetailDiveristyFloraScreen(props){
    ...
    const [schema, setSchema] = useState([
        {
            form:"id_diversity_flora",
            value:props.route.params.id_diversity_flora,
        },
        {
            type:"coordsinput",
            label:"Koordinat",
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   if(check){   
                        ...
                        console.log(payload);
                        let request = await fetch(`${endpoint}/research/diversityFlora/addDetail`,{
                            method:"POST",
                            headers:{
