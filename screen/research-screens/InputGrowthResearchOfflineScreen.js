...
export default function InputGrowthResearchOfflineScreen(props){
    ...
    const [KT12, setKT12] = useState(globalContext.KT12);
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   if(check){   
                        ...
                        if(KT12){
                            setSmokeScreenOpened(false);
                            setKT12([...KT12,...payloadArray]);
                            AsyncStorage.setItem("KT12",JSON.stringify([...KT12,...payloadArray]));
                            console.log([...KT12,...payloadArray]);
                            alert('Berhasil menyimpan data ke local');
                            props.navigation.navigate("ListGrowthResearchOffline");
                        }else{
                            setKT12(payloadArray);
                            AsyncStorage.setItem("KT12",JSON.stringify(payloadArray));
                            setSmokeScreenOpened(false);
                            alert('Berhasil menyimpan data ke local');
                            props.navigation.navigate("ListGrowthResearchOffline");
                        }
