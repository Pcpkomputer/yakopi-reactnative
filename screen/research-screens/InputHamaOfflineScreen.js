...
export default function InputHamaOfflineScreen(props){
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   if(check){   
                        ...
                        if(KT15){
                            setSmokeScreenOpened(false);
                            setKT15([...KT15,...payloadArray]);
                            AsyncStorage.setItem("KT15",JSON.stringify([...KT15,...payloadArray]));
                            console.log([...KT15,...payloadArray]);
                            alert('Berhasil menyimpan data ke local');
                            props.navigation.navigate("ListHamaOffline");
                        }else{
                            setKT15(payloadArray);
                            AsyncStorage.setItem("KT15",JSON.stringify(payloadArray));
                            setSmokeScreenOpened(false);
                            alert('Berhasil menyimpan data ke local');
                            props.navigation.navigate("ListHamaOffline");
                        }
