...
export default function InputFiskimOfflineScreen(props){
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   if(check){   
                        ...
                        if(KT16){
                            setSmokeScreenOpened(false);
                            setKT16([...KT16,...payloadArray]);
                            AsyncStorage.setItem("KT16",JSON.stringify([...KT16,...payloadArray]));
                            alert('Berhasil menyimpan data ke local');
                            props.navigation.navigate("ListFiskimOffline");
                        }else{
                            setKT16(payloadArray);
                            AsyncStorage.setItem("KT16",JSON.stringify(payloadArray));
                            setSmokeScreenOpened(false);
                            alert('Berhasil menyimpan data ke local');
                            props.navigation.navigate("ListFiskimOffline");
                        }
