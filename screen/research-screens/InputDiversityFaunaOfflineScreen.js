...
export default function InputDiversityFaunaOfflineScreen(props){
    ...
    const [KT13, setKT13] = useState(globalContext.KT13);
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   if(check){   
                        ...
                        if(KT13){
                            setSmokeScreenOpened(false);
                            setKT13([...KT13,...payloadArray]);
                            AsyncStorage.setItem("KT13",JSON.stringify([...KT13,...payloadArray]));
                            alert('Berhasil menyimpan data ke local');
                            props.navigation.navigate("ListDiversityFaunaOffline");
                        }else{
                            setKT13(payloadArray);
                            AsyncStorage.setItem("KT13",JSON.stringify(payloadArray));
                            setSmokeScreenOpened(false);
                            alert('Berhasil menyimpan data ke local');
                            props.navigation.navigate("ListDiversityFaunaOffline");
                        }
