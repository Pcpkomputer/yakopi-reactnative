...
export default function ListFiskimOfflineScreen(props){

    const focused = useIsFocused();

    const globalContext = useContext(GlobalContext);
    const [credentials,setCredentials] = useState(globalContext.credentials);
    const [KT16, setKT16] = useState(globalContext.KT16);
    ...
    let fetchList = async () => {
        ...
        let list = await AsyncStorage.getItem("KT16");
    ...
    return (
        <View style={{ flex: 1 }}>
          <TouchableOpacity
            activeOpacity={0.6}
            onPress={() => {
              props.navigation.navigate("InputFiskimOffline");
            }}
            style={{
              position: "absolute",
              zIndex: 9999,
                                    ...
                                    Alert.alert(
                                        ...
                                        [
                                            ...
                                            { text: "Iya", onPress: async () => {
                                                ...
                                                list.splice(index,1);
                                                await AsyncStorage.setItem("KT16",JSON.stringify(list));
                                ...
                                </TouchableOpacity>
                                {
                                    isConnected ? (
                                        ...
                                        onPress={async ()=>{
                                            ...
                                            let request = await fetch(`${endpoint}/research/fiskim/add`,{
                                                method:"POST",
                                                headers:{
