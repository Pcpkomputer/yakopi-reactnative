...
import RestorationTimeInput from '../restoration-components/RestorationTimeInput';
...
export default function InputDetailFiskimScreen(props){
    ...
    const [schema, setSchema] = useState([
        {
            form:"id_fiskim",
            value:props.route.params.id_fiskim,
        },
        {
            type:"dateTime",
            label:"Waktu",
        ...
        {
            type:"textinput",
            label:"Dissolved Oksigen",
            value:"",
            form:"dissolved_oksigen",
            required:true
        },
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   if(check){   
                        ...
                        console.log(payload);
                        let request = await fetch(`${endpoint}/research/detailFiskim/add`,{
                            method:"POST",
                            headers:{
