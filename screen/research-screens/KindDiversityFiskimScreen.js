...
export default function KindDiveristyFiskimScreen(props){
  ...
  const focused = useIsFocused();
    ...
    let fetchList = async () =>{
        ...
        let request = await fetch(`${endpoint}/research/biodiversity/fiskim`,{
            method:"POST",
            headers:{
    ...
    return (
      <View style={{flex:1, backgroundColor:'#fff'}}>
        ...
        <TouchableOpacity 
            activeOpacity={0.6}
            onPress={()=>{
                props.navigation.navigate("InputDetailDiversityFiskim",{ id_biodiversity:props.route.params.id_biodiversity });
            }}
      ...
      <ScrollView>
        ...
        list.map((item, index) => (
                  ...
                  Alert.alert(
                      ...
                      [
                        ...
                        { text: "Iya", onPress: async () => {
                              ...
                              let id = item.id_biodiversity_fiskim;
                              let request = await fetch(`${endpoint}/research/biodiveristy/deleteFiskim`,{
                                  method:"DELETE",
                                  headers:{
                                      "authorization":`Bearer ${globalContext.credentials.token}`,
                                      "content-type":"application/json"
          ...
          }
          {
            ...
            <DataTable.Cell>{item.hasil_pengukuran}</DataTable.Cell>
          </DataTable.Row>
        ))}
        </DataTable>
      </ScrollView>
