...
export default function InputDetailPlanktonFiskimScreen(props){
    ...
    const [schema, setSchema] = useState([
        {
            form:"id_plankton",
            value:props.route.params.id_plankton,
        },
        {
            type:"textinput",
            label:"Parameter",
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   if(check){   
                        ...
                        console.log(payload);
                        let request = await fetch(`${endpoint}/research/plankton/addFiskim`,{
                            method:"POST",
                            headers:{
