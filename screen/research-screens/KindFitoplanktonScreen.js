...
export default function KindFitoplanktonScreen(props){
  ...
  const focused = useIsFocused();
    ...
    let fetchList = async () =>{
        ...
        let request = await fetch(`${endpoint}/research/plankton/fitoplankton`,{
            method:"POST",
            headers:{
    ...
    return (
      <View style={{flex:1, backgroundColor:'#fff'}}>
        ...
        <TouchableOpacity 
            activeOpacity={0.6}
            onPress={()=>{
                props.navigation.navigate("InputDetailFitoplankton",{ id_plankton:props.route.params.id_plankton });
            }}
                  ...
                  Alert.alert(
                      ...
                      [
                        ...
                        { text: "Iya", onPress: async () => {
                              ...
                              let id = item.id_plankton_fitoplankton;
                              let request = await fetch(`${endpoint}/research/plankton/deleteFitoplankton`,{
                                  method:"DELETE",
                                  headers:{
                                      "authorization":`Bearer ${globalContext.credentials.token}`,
                                      "content-type":"application/json"
