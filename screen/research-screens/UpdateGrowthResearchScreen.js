...
export default function UpdateGrowthResearchScreen(props){
    ...
    const [schema, setSchema] = useState([
        ...
        },
        {
            type:"textinput",
            label:"Monitoring Ke",
            value:props.route.params.item.monitoring_ke || "",
            form:"monitoring_ke",
            required:true
        },
        {
            ...
            value:{
                id:props.route.params.item.position || -1,
                value:props.route.params.item.position || "",
            },
            form:"position",
            required:true
        },
        {
            ...
            value:props.route.params.item.distance || "",
            form:"distance",
            required:true
        },
        {
            ...
            value:props.route.params.item.type_magrove || "",
            form:"type_magrove",
            required:true
        },
        {
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   let check = required.every((item)=>{
                        ...
                        try{
                            let request = await fetch(`${endpoint}/research/growthResearch/update/${props.route.params.item.id_growth_research}`,{
                                method:"PUT",
                                headers:{
                                    "authorization":`Bearer ${globalContext.credentials.token}`,
