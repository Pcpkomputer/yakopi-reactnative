...
export default function UpdateCCBScreen(props){
    ...
    const [schema, setSchema] = useState([
        ...
        },
        {
            ...
            value:props.route.params.item.carbon_project,
            form:"carbon_project",
            required:true
        },
        {
        ...
        },
        {
            ...
            label:"Koordinat",
            value:{
                latitude:props.route.params.item.lat_ccb || "",
                longitude:props.route.params.item.long_ccb || "",
            },
            form:"coordinate",
            required:false
        },
        ...
        },
        {
            type:"dateinput",
            label:"Tanggal",
            value:props.route.params.item.tanggal_ccb,
            form:"tanggal_ccb",
            required:true
        },
        {
        ...
        },
        {
            type:"textinput",
            label:"Forest Type",
            value:props.route.params.item.forest_type,
            form:"forest_type",
            required:false
        },
        {
            type:"textinput",
            label:"Jenis substrat",
            value:props.route.params.item.jenis_substrat,
            form:"jenis_substrat",
            required:false
        }
    ]);
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   if(check){   
                        ...
                        console.log(payload);
                        try{
                            let request = await fetch(`${endpoint}/research/ccb/update/${props.route.params.item.id_ccb}`,{
                                method:"PUT",
                                headers:{
                                    "authorization":`Bearer ${globalContext.credentials.token}`,
