...
export default function ListHamaOfflineScreen(props){

    const focused = useIsFocused();

    const globalContext = useContext(GlobalContext);
    const [credentials,setCredentials] = useState(globalContext.credentials);
    const [KT15, setKT15] = useState(globalContext.KT15);
    ...
    let fetchList = async () => {
        ...
        let list = await AsyncStorage.getItem("KT15");
    ...
    return (
        <View style={{ flex: 1 }}>
          <TouchableOpacity
            activeOpacity={0.6}
            onPress={() => {
              props.navigation.navigate("InputHamaOffline");
            }}
            style={{
              position: "absolute",
              zIndex: 9999,
                                    ...
                                    Alert.alert(
                                        ...
                                        [
                                            ...
                                            { text: "Iya", onPress: async () => {
                                                ...
                                                list.splice(index,1);
                                                await AsyncStorage.setItem("KT15",JSON.stringify(list));
                                ...
                                </TouchableOpacity>
                                {
                                    isConnected ? (
                                        ...
                                        onPress={async ()=>{
                                            ...
                                            let request = await fetch(`${endpoint}/research/hama/add`,{
                                                method:"POST",
                                                headers:{
