...
export default function UpdatePlanktonScreen(props){
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   if(check){   
                        ...
                        console.log(payload);
                        try{
                            let request = await fetch(`${endpoint}/research/plankton/update/${props.route.params.item.id_biodiversity_planton}`,{
                                method:"PUT",
                                headers:{
                                    "authorization":`Bearer ${globalContext.credentials.token}`,
