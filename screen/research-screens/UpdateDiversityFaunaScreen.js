...
export default function UpdateDiversityFaunaScreen(props){
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   if(check){   
                        ...
                        console.log(payload);
                        try{
                            let request = await fetch(`${endpoint}/research/biodiversity/update/${props.route.params.item.id_biodiversity}`,{
                                method:"PUT",
                                headers:{
                                    "authorization":`Bearer ${globalContext.credentials.token}`,
