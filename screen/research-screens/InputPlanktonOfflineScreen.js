...
export default function InputPlanktonScreen(props){
    ...
    useEffect(()=>{
        setPlankton(globalContext.plankton);
    },[focused]);
               ...
               <TouchableOpacity 
                    ...
                    onPress={async () => {
                        ...
                        try {
                            ...
                            let existingData = await AsyncStorage.getItem("plankton");
                            existingData = JSON.parse(existingData) || [];
    
                            let newData = [...existingData, payload];
    
                            setPlankton(newData);
                            await AsyncStorage.setItem("plankton", JSON.stringify(newData));
    
                            setSmokeScreenOpened(false);
                            alert('Berhasil menyimpan data ke local');
                            props.navigation.navigate("ListPlanktonOffline");
