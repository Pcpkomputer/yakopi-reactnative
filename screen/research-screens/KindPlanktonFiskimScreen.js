...
export default function KindPlanktonFiskimScreen(props){
  ...
  const focused = useIsFocused();
    ...
    let fetchList = async () =>{
        ...
        let request = await fetch(`${endpoint}/research/plankton/fiskim`,{
            method:"POST",
            headers:{
    ...
    return (
      <View style={{flex:1, backgroundColor:'#fff'}}>
        ...
        <TouchableOpacity 
            activeOpacity={0.6}
            onPress={()=>{
                props.navigation.navigate("InputDetailPlanktonFiskim",{ id_plankton:props.route.params.id_plankton });
            }}
                  ...
                  Alert.alert(
                      ...
                      [
                        ...
                        { text: "Iya", onPress: async () => {
                              ...
                              let id = item.id_plankton_fiskim;
                              let request = await fetch(`${endpoint}/research/plankton/deleteFiskim`,{
                                  method:"DELETE",
                                  headers:{
                                      "authorization":`Bearer ${globalContext.credentials.token}`,
                                      "content-type":"application/json"
