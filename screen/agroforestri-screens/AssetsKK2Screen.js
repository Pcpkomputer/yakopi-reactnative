...
function AssetsVideo(props){
    ...
    const fetchVideo = async()=>{
        ...
        let request = await fetch(`${endpoint}/video-agroforest-kt2`,{
            method:"POST",
            headers:{
    ...
    useEffect(()=>{
        props.navigation.setOptions({
            headerTitle: `Video - ${props.route.params.id_agroforest_kt2}`,
        });
    },[])
                        ...
                        onPress={async ()=>{
                            ...
                            if(required){
                                ...
                                if(gambar.type==="success"){
                                    ...
                                    let req2 = await fetch(`${endpoint}/add-video-agroforest-kt2`,{
                                        method:"POST",
                                        headers:{
                                            "authorization":`Bearer ${globalContext.credentials.token}`,
                                            "content-type":"application/json"
                                        ...
                                        Alert.alert(
                                            ...
                                            [
                                              ...
                                              { text: "Iya", onPress: async () => {
                                                    ...
                                                    let id = item.id_agroforest_kt2_video;
                                                    let request = await fetch(`${endpoint}/delete-video-agroforest-kt2`,{
                                                        method:"DELETE",
                                                        headers:{
                                                            "authorization":`Bearer ${globalContext.credentials.token}`,
                                                            "content-type":"application/json"
...
function AssetsDrone(props){
    ...
    const fetchImage = async()=>{
        setImageLoading(true);
        let id = props.route.params.id_agroforest_kt2;
        let request = await fetch(`${endpoint}/drone-agroforest-kt2`,{
            method:"POST",
            headers:{
                "authorization":`Bearer ${globalContext.credentials.token}`,
                "content-type":"application/json"
    ...
    useEffect(()=>{
        props.navigation.setOptions({
            headerTitle: `Drone - ${props.route.params.id_agroforest_kt2}`,
        });
    },[])
                        ...
                        onPress={async ()=>{
                            ...
                            if(required){
                                ...
                                if(!gambar.canceled){
                                    ...
                                    let req2 = await fetch(`${endpoint}/add-drone-agroforest-kt2`,{
                                        method:"POST",
                                        headers:{
                                            "authorization":`Bearer ${globalContext.credentials.token}`,
                                            "content-type":"application/json"
                                        ...
                                        Alert.alert(
                                            ...
                                            [
                                              ...
                                              { text: "Iya", onPress: async () => {
                                                    ...
                                                    let id = item.id_agroforest_kt2_drone;
                                                    let request = await fetch(`${endpoint}/delete-drone-agroforest-kt2`,{
                                                        method:"DELETE",
                                                        headers:{
                                                            "authorization":`Bearer ${globalContext.credentials.token}`,
                                                            "content-type":"application/json"
...
function AssetsImage(props){
    ...
    const fetchImage = async()=>{
        setImageLoading(true);
        let id = props.route.params.id_agroforest_kt2;
        let request = await fetch(`${endpoint}/photo-agroforest-kt2`,{
            method:"POST",
            headers:{
                "authorization":`Bearer ${globalContext.credentials.token}`,
                "content-type":"application/json"
    ...
    useEffect(()=>{
        props.navigation.setOptions({
            headerTitle: `Photo - ${props.route.params.id_agroforest_kt2}`,
        });
    },[])
                        ...
                        onPress={async ()=>{
                            ...
                            if(required){
                                ...
                                if(!gambar.canceled){
                                    ...
                                    let req2 = await fetch(`${endpoint}/add-photo-agroforest-kt2`,{
                                        method:"POST",
                                        headers:{
                                            "authorization":`Bearer ${globalContext.credentials.token}`,
                                            "content-type":"application/json"
                                        ...
                                        Alert.alert(
                                            ...
                                            [
                                              ...
                                              { text: "Iya", onPress: async () => {
                                                    ...
                                                    let id = item.id_agroforest_kt2_photo;
                                                    let request = await fetch(`${endpoint}/delete-photo-agroforest-kt2`,{
                                                        method:"DELETE",
                                                        headers:{
                                                            "authorization":`Bearer ${globalContext.credentials.token}`,
                                                            "content-type":"application/json"
