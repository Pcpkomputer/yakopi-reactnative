...
export default function UpdateKK5Screen(props){
    ...
    const [data,setData] = useState({
        ...
        city:[],
        district:[],
        jenis_transportasi:["Mobil","Sepeda Motor"].map((item,_)=>{return {id:item,value:item}}),
    });
    ...
    const [schema, setSchema] = useState([
        ...
        },
        {
            ...
            value:{
                id:props.route.params.item.jenis_transportasi || "",
                value:props.route.params.item.jenis_transportasi || "",
            },
            form:"jenis_transportasi",
            required:true
        },
        {
            type:"spacer",
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   console.log(check);
                    ...
                    try{
                        let request = await fetch(`${endpoint}/agroforest-kt5/update/${props.route.params.item.id_agroforest_kt5}`,{
                            method:"PUT",
                            headers:{
                                "authorization":`Bearer ${globalContext.credentials.token}`,
