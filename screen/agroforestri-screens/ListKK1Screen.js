...
export default function ListKK1Screen(props){
    ...
    return (
        <View style={{flex:1}}>
            ...
            activeOpacity={0.6}
            onPress={()=>{
                props.navigation.navigate("InputKK1");
            }}
                ...
                <ScrollView contentContainerStyle={{paddingTop:EStyleSheet.value("20rem")}}>
                 {
                     list.map((item,index)=>{
                         return (
                            ...
                            activeOpacity={0.7}
                            onPress={()=>{
                                props.navigation.navigate("DetailKK1",{item:item});
                            }}
                            ...
                            style={{flexDirection:"row",marginHorizontal:EStyleSheet.value("20rem"),borderRadius:EStyleSheet.value("5rem")}}>
                                <View style={{paddingHorizontal:EStyleSheet.value("20rem"),justifyContent:"center",alignItems:"center",paddingVertical:EStyleSheet.value("20rem")}}>
                                    <Text style={{color:"white",fontSize:EStyleSheet.value("20rem"),fontWeight:"bold"}}>{item.id_agroforest_kt1}</Text>
                                </View>
                                <View style={{flexDirection:"column",flex:1}}>
                                    ...
                                    <ScrollView showsHorizontalScrollIndicator={false} horizontal={true} style={{paddingHorizontal:EStyleSheet.value("10rem"),flexDirection:"row"}}>
                                        ...
                                        <Text style={{fontSize:EStyleSheet.value("11rem"),color:"white"}}>{item.date_kt1}</Text>
                                        </View>
                                    </ScrollView>
                            ...
                            <View style={{marginHorizontal:EStyleSheet.value("20rem"),flexDirection:"row",justifyContent:"space-around",padding:EStyleSheet.value("10rem"),backgroundColor:"#DDDDDD"}}>
                                <TouchableOpacity 
                                onPress={()=>{
                                    props.navigation.navigate("AssetsKK1",{type:"image",site_code:item.site_code,id_agroforest_kt1:item.id_agroforest_kt1,status:item.status,verifikasi_1:item.verifikasi_1,verifikasi_2:item.verifikasi_2});
                                }}
                                ...
                                <TouchableOpacity 
                                 onPress={()=>{
                                    props.navigation.navigate("AssetsKK1",{type:"video",site_code:item.site_code,id_agroforest_kt1:item.id_agroforest_kt1,status:item.status,verifikasi_1:item.verifikasi_1,verifikasi_2:item.verifikasi_2});
                                }}
                                ...
                                <TouchableOpacity 
                                 onPress={()=>{
                                    props.navigation.navigate("AssetsKK1",{type:"drone",site_code:item.site_code,id_agroforest_kt1:item.id_agroforest_kt1,status:item.status,verifikasi_1:item.verifikasi_1,verifikasi_2:item.verifikasi_2});
                                }}
                                        ...
                                        Alert.alert(
                                            ...
                                            [
                                              ...
                                              { text: "Iya", onPress: async () => {
                                                    ...
                                                    let id = item.id_agroforest_kt1;
                                                    let request = await fetch(`${endpoint}/agroforest-kt1-verifikasi_1`,{
                                                        method:"POST",
                                                        headers:{
                                                            "authorization":`Bearer ${globalContext.credentials.token}`,
                                        ...
                                        Alert.alert(
                                            ...
                                            [
                                              ...
                                              { text: "Iya", onPress: async () => {
                                                    ...
                                                    let id = item.id_agroforest_kt1;
                                                    let request = await fetch(`${endpoint}/agroforest-kt1-verifikasi_2`,{
                                                        method:"POST",
                                                        headers:{
                                                            "authorization":`Bearer ${globalContext.credentials.token}`,
                                                            "content-type":"application/json"
                                        ...
                                        Alert.alert(
                                            ...
                                            [
                                              ...
                                              { text: "Iya", onPress: async () => {
                                                    ...
                                                    let id = item.id_agroforest_kt1;
                                                    let request = await fetch(`${endpoint}/approve-agroforest-kt1`,{
                                                        method:"POST",
                                                        headers:{
                                                            "authorization":`Bearer ${globalContext.credentials.token}`,
                                                            "content-type":"application/json"
                                        ...
                                        Alert.alert(
                                            ...
                                            [
                                              ...
                                              { text: "Iya", onPress: async () => {
                                                    ...
                                                    let id = item.id_agroforest_kt1;
                                                    let request = await fetch(`${endpoint}/delete-agroforest-kt1`,{
                                                        method:"DELETE",
                                                        headers:{
                                                            "authorization":`Bearer ${globalContext.credentials.token}`,
                                                            "content-type":"application/json"
                            ...
                            <View style={{marginHorizontal:EStyleSheet.value("20rem"),justifyContent:"space-around",padding:EStyleSheet.value("10rem"),backgroundColor:"#DDDDDD"}}>
                                <TouchableOpacity
                                onPress={()=>{
                                    props.navigation.navigate("UpdateKK1",{item:item});
                                }}
                                style={{backgroundColor:"#05ACAC",borderRadius:EStyleSheet.value("5rem"),paddingHorizontal:EStyleSheet.value("10rem"),paddingVertical:EStyleSheet.value("5rem")}}>
