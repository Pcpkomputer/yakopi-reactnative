...
export default function UpdateKK2Screen(props){
    ...
    const [data,setData] = useState({
        ...
        city:[],
        district:[],
        jenis_transportasi_1:["Boat","Mobil","Sepeda Motor"].map((item,_)=>{return {id:item,value:item}}),
        jenis_transportasi_2:["Boat","Mobil","Sepeda Motor"].map((item,_)=>{return {id:item,value:item}}),
    });
    ...
    const [schema, setSchema] = useState([
        ...
        },
        {
            ...
            value:{
                id:props.route.params.item.jenis_transportasi_1 || -1,
                value:props.route.params.item.jenis_transportasi_1 || "",
            },
            form:"jenis_transportasi_1",
            required:true
        },
        {
            type:"selectinput",
            ...
            value:{
                id:props.route.params.item.jenis_transportasi_2 || -1,
                value:props.route.params.item.jenis_transportasi_2 || "",
            },
            form:"jenis_transportasi_2",
            required:true
        },
        {
            type:"spacer",
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   console.log(check);
                    ...
                    try{
                        let request = await fetch(`${endpoint}/agroforest-kt2/update/${props.route.params.item.id_agroforest_kt2}`,{
                            method:"PUT",
                            headers:{
                                "authorization":`Bearer ${globalContext.credentials.token}`,
