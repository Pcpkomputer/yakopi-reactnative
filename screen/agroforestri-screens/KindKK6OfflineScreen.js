...
export default function KindKK6Offline(props){
    ...
    const id_agroforest_KK6 = props.route.params.id_agroforest_KK6;
    ...
    let fetchList = async () =>{
        setListLoading(true);
        let list = await AsyncStorage.getItem("KK6Kind");
        console.log(list);
        ...
        list = list.filter((item)=>{
            return item.id === id_agroforest_KK6;
        })
        setList(list);
    ...
    return (
      <View style={{flex:1, backgroundColor:'#fff'}}>
        <TouchableOpacity 
            activeOpacity={0.6}
            onPress={()=>{
                props.navigation.navigate("InputDetailKK6Offline",{ id_agroforest_KK6:props.route.params.id_agroforest_KK6 });
            }}
                      ...
                      [
                          ...
                          { 
                              ...
                              onPress: async () => {
                                  ...
                                  list.splice(index, 1);
                                  await AsyncStorage.setItem("KK6Kind", JSON.stringify(list));
