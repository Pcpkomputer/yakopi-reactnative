...
export default function KindKK3Offline(props){
    ...
    const id_agroforest_KK3 = props.route.params.id_agroforest_KK3;
    ...
    let fetchList = async () =>{
        setListLoading(true);
        let list = await AsyncStorage.getItem("KK3Kind");
        console.log(list);
        ...
        list = list.filter((item)=>{
            return item.id === id_agroforest_KK3;
        })
        setList(list);
    ...
    return (
      <View style={{flex:1, backgroundColor:'#fff'}}>
        <TouchableOpacity 
            activeOpacity={0.6}
            onPress={()=>{
                props.navigation.navigate("InputDetailKK3Offline",{ id_agroforest_KK3:props.route.params.id_agroforest_KK3 });
            }}
      ...
      <ScrollView horizontal>
        ...
        list.map((item, index) => (
          <DataTable.Row key={index}>
                      ...
                      [
                          ...
                          { 
                              ...
                              onPress: async () => {
                                  ...
                                  list.splice(index, 1);
                                  await AsyncStorage.setItem("KK3Kind", JSON.stringify(list));
            ...
            <DataTable.Cell style={{flex:1,width:Dimensions.get("window").width/3}}>{item.date_kt3_detail}</DataTable.Cell>
