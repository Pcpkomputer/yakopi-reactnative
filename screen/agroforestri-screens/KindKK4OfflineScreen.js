...
export default function KindKK4Offline(props){
    ...
    const id_agroforest_KK4 = props.route.params.id_agroforest_KK4;
    ...
    let fetchList = async () =>{
        setListLoading(true);
        let list = await AsyncStorage.getItem("KK4Kind");
        console.log(list);
        ...
        list = list.filter((item)=>{
            return item.id === id_agroforest_KK4;
        })
        setList(list);
    ...
    return (
      <View style={{flex:1, backgroundColor:'#fff'}}>
        <TouchableOpacity 
            activeOpacity={0.6}
            onPress={()=>{
                props.navigation.navigate("InputDetailKK4Offline",{ id_agroforest_KK4:props.route.params.id_agroforest_KK4 });
            }}
      ...
      <ScrollView horizontal>
        ...
        list.map((item, index) => (
          <DataTable.Row key={index}>
                      ...
                      [
                          ...
                          { 
                              ...
                              onPress: async () => {
                                  ...
                                  list.splice(index, 1);
                                  await AsyncStorage.setItem("KK4Kind", JSON.stringify(list));
            ...
            <DataTable.Cell style={{flex:1,width:Dimensions.get("window").width/3}}>{item.date_kt4_detail}</DataTable.Cell>
