...
export default function KindKK4(props){
    ...
    let fetchList = async () =>{
        setListLoading(true);
        let id = props.route.params.id_agroforest_kt4;
        let request = await fetch(`${endpoint}/kind-agroforest-kt4`,{
            method:"POST",
            headers:{
    ...
    return (
      <View style={{flex:1, backgroundColor:'#fff'}}>
        <TouchableOpacity 
            activeOpacity={0.6}
            onPress={()=>{
                props.navigation.navigate("InputDetailKK4",{ id_agroforest_kt4:props.route.params.id_agroforest_kt4 });
            }}
                  ...
                  Alert.alert(
                      ...
                      [
                        ...
                        { text: "Iya", onPress: async () => {
                              ...
                              let id = item.id_agroforest_kt4_detail;
                              let request = await fetch(`${endpoint}/delete-kind-agroforest-kt4`,{
                                  method:"DELETE",
                                  headers:{
                                      "authorization":`Bearer ${globalContext.credentials.token}`,
                                      "content-type":"application/json"
