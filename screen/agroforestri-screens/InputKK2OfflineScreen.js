...
export default function InputKK2OfflineScreen(props){
               ...
               <TouchableOpacity 
                    ...
                    onPress={async () => {
                        ...
                        try {
                            ...
                            let existingData = await AsyncStorage.getItem("KK2");
                            existingData = JSON.parse(existingData) || [];
    
                            let newData = [...existingData, payload];
    
                            setKK2(newData);
                            await AsyncStorage.setItem("KK2", JSON.stringify(newData));
    
                            setSmokeScreenOpened(false);
                            alert('Berhasil menyimpan data ke local');
                            props.navigation.navigate("ListKK2Offline");
