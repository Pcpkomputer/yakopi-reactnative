...
export default function KindKK3(props){
    ...
    let fetchList = async () =>{
        ...
        let request = await fetch(`${endpoint}/kind-agroforest-kt3`,{
            method:"POST",
            headers:{
    ...
    return (
      <View style={{flex:1, backgroundColor:'#fff'}}>
        <TouchableOpacity 
            activeOpacity={0.6}
            onPress={()=>{
                props.navigation.navigate("InputDetailKK3",{ id_agroforest_kt3:props.route.params.id_agroforest_kt3 });
            }}
                  ...
                  Alert.alert(
                      ...
                      [
                        ...
                        { text: "Iya", onPress: async () => {
                              ...
                              let id = item.id_agroforest_kt3_detail;
                              let request = await fetch(`${endpoint}/delete-kind-agroforest-kt3`,{
                                  method:"DELETE",
                                  headers:{
                                      "authorization":`Bearer ${globalContext.credentials.token}`,
                                      "content-type":"application/json"
