...
export default function InputKK4OfflineScreen(props){
               ...
               <TouchableOpacity 
                    ...
                    onPress={async () => {
                        ...
                        try {
                            ...
                            let existingData = await AsyncStorage.getItem("KK4");
                            existingData = JSON.parse(existingData) || [];
    
                            let newData = [...existingData, payload];
    
                            setKK4(newData);
                            await AsyncStorage.setItem("KK4", JSON.stringify(newData));
