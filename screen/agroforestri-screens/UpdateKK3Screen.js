...
export default function UpdateKK3Screen(props){
    ...
    const [schema, setSchema] = useState([
        ...
        {
            type:"textinput",
            label:"Verifikasi Pembibitan Ke-",
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   console.log(check);
                    ...
                    try{
                        let request = await fetch(`${endpoint}/agroforest-kt3/update/${props.route.params.item.id_agroforest_kt3}`,{
                            method:"PUT",
                            headers:{
                                "authorization":`Bearer ${globalContext.credentials.token}`,
