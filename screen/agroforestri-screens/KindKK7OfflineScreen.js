...
export default function KindKK7Offline(props){
    ...
    const id_agroforest_KK7 = props.route.params.id_agroforest_KK7;
    ...
    let fetchList = async () =>{
        setListLoading(true);
        let list = await AsyncStorage.getItem("KK7Kind");
        console.log(list);
        ...
        list = list.filter((item)=>{
            return item.id === id_agroforest_KK7;
        })
        setList(list);
    ...
    return (
      <View style={{flex:1, backgroundColor:'#fff'}}>
        <TouchableOpacity 
            activeOpacity={0.6}
            onPress={()=>{
                props.navigation.navigate("InputDetailKK7Offline",{ id_agroforest_KK7:props.route.params.id_agroforest_KK7 });
            }}
                      ...
                      [
                          ...
                          { 
                              ...
                              onPress: async () => {
                                  ...
                                  list.splice(index, 1);
                                  await AsyncStorage.setItem("KK7Kind", JSON.stringify(list));
