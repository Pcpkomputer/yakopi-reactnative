...
export default function UpdateKK4Screen(props){
    ...
    const [schema, setSchema] = useState([
        ...
        },
        {
            ...
            value:{
                id:props.route.params.item.sub_ekosistem || "",
                value:props.route.params.item.sub_ekosistem || "",
            },
            form:"sub_ekosistem",
            required:true
        },
        {
            type:"textinput",
            label:"Keberadaan jenis-jenis tanaman agroforestri yang sudah ada di lokasi tanam dan perkiraan persentasenya",
            value:props.route.params.item.jenis_tanam || "",
            form:"jenis_tanam",
            required:false
        },
        {
            ...
            value:{
                id:props.route.params.item.transportasi || "",
                value:props.route.params.item.transportasi || "",
            },
            form:"transportasi",
            required:true
        },
        {
            type:"textinput",
            label:"Verifikasi Penanaman Ke-",
            value:props.route.params.item.verifikasi_ke || "",
            form:"verifikasi_ke",
            required:false
        },
        {
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   console.log(check);
                    ...
                    try{
                        let request = await fetch(`${endpoint}/agroforest-kt4/update/${props.route.params.item.id_agroforest_kt4}`,{
                            method:"PUT",
                            headers:{
                                "authorization":`Bearer ${globalContext.credentials.token}`,
