...
export default function KindKK10(props){
    ...
    let fetchList = async () =>{
        setListLoading(true);
        let id = props.route.params.id_agroforest_kt10;
        let request = await fetch(`${endpoint}/kind-agroforest-kt10`,{
            method:"POST",
            headers:{
    ...
    return (
      <View style={{flex:1, backgroundColor:'#fff'}}>
        <TouchableOpacity 
            activeOpacity={0.6}
            onPress={()=>{
                props.navigation.navigate("InputDetailKK10",{ id_agroforest_kt10:props.route.params.id_agroforest_kt10 });
            }}
                  ...
                  Alert.alert(
                      ...
                      [
                        ...
                        { text: "Iya", onPress: async () => {
                              ...
                              let id = item.id_agroforest_kt10_detail;
                              let request = await fetch(`${endpoint}/delete-kind-agroforest-kt10`,{
                                  method:"DELETE",
                                  headers:{
                                      "authorization":`Bearer ${globalContext.credentials.token}`,
                                      "content-type":"application/json"
