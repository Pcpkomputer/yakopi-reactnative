...
export default function KindKK8(props){
    ...
    let fetchList = async () =>{
        setListLoading(true);
        let id = props.route.params.id_agroforest_kt8;
        let request = await fetch(`${endpoint}/kind-agroforest-kt8`,{
            method:"POST",
            headers:{
    ...
    return (
      <View style={{flex:1, backgroundColor:'#fff'}}>
        <TouchableOpacity 
            activeOpacity={0.6}
            onPress={()=>{
                props.navigation.navigate("InputDetailKK8",{ id_agroforest_kt8:props.route.params.id_agroforest_kt8 });
            }}
                  ...
                  Alert.alert(
                      ...
                      [
                        ...
                        { text: "Iya", onPress: async () => {
                              ...
                              let id = item.id_agroforest_kt8_detail;
                              let request = await fetch(`${endpoint}/delete-kind-agroforest-kt8`,{
                                  method:"DELETE",
                                  headers:{
                                      "authorization":`Bearer ${globalContext.credentials.token}`,
                                      "content-type":"application/json"
