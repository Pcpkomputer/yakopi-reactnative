...
export default function InputKK7OfflineScreen(props){
               ...
               <TouchableOpacity 
                    ...
                    onPress={async () => {
                        ...
                        try {
                            ...
                            let existingData = await AsyncStorage.getItem("KK7");
                            existingData = JSON.parse(existingData) || [];
    
                            let newData = [...existingData, payload];
    
                            setKK7(newData);
                            await AsyncStorage.setItem("KK7", JSON.stringify(newData));
    
                            setSmokeScreenOpened(false);
                            alert('Berhasil menyimpan data ke local');
                            props.navigation.navigate("ListKK7Offline");
