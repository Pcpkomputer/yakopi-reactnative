...
export default function UpdateKK6Screen(props){
    ...
    const [data,setData] = useState({
        ...
        city:[],
        district:[],
        lahan:["field/Ladang","yard/pekarangan"].map((item,_)=>{return {id:item,value:item}}),
    });
    ...
    const [schema, setSchema] = useState([
        ...
        },
        {
            ...
            value:{
                id:props.route.params.item.lahan || -1,
                value:props.route.params.item.lahan || "",
            },
            form:"lahan",
            required:true
        },
        ...
        {
            type:"textinput",
            label:"Boundering Tanam Termin (Verifikasi Ke-)",
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   console.log(check);
                    ...
                    try{
                        let request = await fetch(`${endpoint}/agroforest-kt6/update/${props.route.params.item.id_agroforest_kt6}`,{
                            method:"PUT",
                            headers:{
                                "authorization":`Bearer ${globalContext.credentials.token}`,
