...
export default function KindKK8Offline(props){
    ...
    const id_agroforest_KK8 = props.route.params.id_agroforest_KK8;
    ...
    let fetchList = async () =>{
        setListLoading(true);
        let list = await AsyncStorage.getItem("KK8Kind");
        console.log(list);
        ...
        list = list.filter((item)=>{
            return item.id === id_agroforest_KK8;
        })
        setList(list);
    ...
    return (
      <View style={{flex:1, backgroundColor:'#fff'}}>
        <TouchableOpacity 
            activeOpacity={0.6}
            onPress={()=>{
                props.navigation.navigate("InputDetailKK8Offline",{ id_agroforest_KK8:props.route.params.id_agroforest_KK8 });
            }}
                      ...
                      [
                          ...
                          { 
                              ...
                              onPress: async () => {
                                  ...
                                  list.splice(index, 1);
                                  await AsyncStorage.setItem("KK8Kind", JSON.stringify(list));
