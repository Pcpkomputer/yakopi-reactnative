...
export default function KindKK5(props){
    ...
    let fetchList = async () =>{
        setListLoading(true);
        let id = props.route.params.id_agroforest_kt5;
        let request = await fetch(`${endpoint}/kind-agroforest-kt5`,{
            method:"POST",
            headers:{
    ...
    return (
      <View style={{flex:1, backgroundColor:'#fff'}}>
        <TouchableOpacity 
            activeOpacity={0.6}
            onPress={()=>{
                props.navigation.navigate("InputDetailKK5",{ id_agroforest_kt5:props.route.params.id_agroforest_kt5 });
            }}
                  ...
                  Alert.alert(
                      ...
                      [
                        ...
                        { text: "Iya", onPress: async () => {
                              ...
                              let id = item.id_agroforest_kt5_detail;
                              let request = await fetch(`${endpoint}/delete-kind-agroforest-kt5`,{
                                  method:"DELETE",
                                  headers:{
                                      "authorization":`Bearer ${globalContext.credentials.token}`,
                                      "content-type":"application/json"
