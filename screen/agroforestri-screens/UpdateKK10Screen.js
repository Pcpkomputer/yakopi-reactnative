...
export default function UpdateKK10Screen(props){
    ...
    const [data,setData] = useState({
        ...
        city:[],
        district:[],
        sub_ekosistem:["field/Ladang","yard/pekarangan"].map((item,_)=>{return {id:item,value:item}}),
    });
    ...
    const [schema, setSchema] = useState([
        ...
        },
        {
            ...
            value:{
                id:props.route.params.item.sub_ekosistem || -1,
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   console.log(check);
                    ...
                    try{
                        let request = await fetch(`${endpoint}/agroforest-kt10/update/${props.route.params.item.id_agroforest_kt10}`,{
                            method:"PUT",
                            headers:{
                                "authorization":`Bearer ${globalContext.credentials.token}`,
