...
export default function InputKK5OfflineScreen(props){
               ...
               <TouchableOpacity 
                    ...
                    onPress={async () => {
                        ...
                        try {
                            ...
                            let existingData = await AsyncStorage.getItem("KK5");
                            existingData = JSON.parse(existingData) || [];
    
                            let newData = [...existingData, payload];
    
                            setKK5(newData);
                            await AsyncStorage.setItem("KK5", JSON.stringify(newData));
    
                            setSmokeScreenOpened(false);
                            alert('Berhasil menyimpan data ke local');
                            props.navigation.navigate("ListKK5Offline");
