...
function AssetsVideo(props){
    ...
    const fetchVideo = async()=>{
        ...
        let id = props.route.params.id_agroforest_kt1;
        let request = await fetch(`${endpoint}/video-agroforest-kt1`,{
            method:"POST",
            headers:{
    ...
    useEffect(()=>{
        props.navigation.setOptions({
            headerTitle: `Video KK 1 - ${props.route.params.site_code}`,
        });
    },[])
                        ...
                        onPress={async ()=>{
                            ...
                            if(required){
                                ...
                                if(gambar.type==="success"){
                                    ...
                                    let req2 = await fetch(`${endpoint}/add-video-agroforest-kt1`,{
                                        method:"POST",
                                        headers:{
                                            "authorization":`Bearer ${globalContext.credentials.token}`,
                                            "content-type":"application/json"
                                        ...
                                        Alert.alert(
                                            ...
                                            [
                                              ...
                                              { text: "Iya", onPress: async () => {
                                                    ...
                                                    let id = item.id_agroforest_kt1_video;
                                                    let request = await fetch(`${endpoint}/delete-video-agroforest-kt1`,{
                                                        method:"DELETE",
                                                        headers:{
                                                            "authorization":`Bearer ${globalContext.credentials.token}`,
                                                            "content-type":"application/json"
...
function AssetsDrone(props){
    ...
    const fetchImage = async()=>{
        setImageLoading(true);
        let id = props.route.params.id_agroforest_kt1;
        let request = await fetch(`${endpoint}/drone-agroforest-kt1`,{
            method:"POST",
            headers:{
                "authorization":`Bearer ${globalContext.credentials.token}`,
                "content-type":"application/json"
    ...
    useEffect(()=>{
        props.navigation.setOptions({
            headerTitle: `Drone KK1 - ${props.route.params.site_code}`,
        });
    },[])
...

{
                        ...
                        onPress={async ()=>{
                            ...
                            if(required){
                                ...
                                if(!gambar.canceled){
                                    ...
                                    let req2 = await fetch(`${endpoint}/add-drone-agroforest-kt1`,{
                                        method:"POST",
                                        headers:{
                                            "authorization":`Bearer ${globalContext.credentials.token}`,
                                            "content-type":"application/json"
...

            {
                ...
                <FlatList
                    ...
                    data={image}
                    renderItem={({item,index})=>{
                        console.log(`${endpoint.replace(/api(.?)/g,"")}${item.file}`);
                        return (
                            <View style={{marginHorizontal:EStyleSheet.value("20rem"),overflow:"hidden",borderRadius:EStyleSheet.value("3rem"),marginBottom:EStyleSheet.value("15rem")}}>
                                <View style={{backgroundColor:"#e8e8e8",height:EStyleSheet.value("200rem")}}>
                                    {
                                        ...
                                        Alert.alert(
                                            ...
                                            [
                                              ...
                                              { text: "Iya", onPress: async () => {
                                                    ...
                                                    let id = item.id_agroforest_kt1_drone;
                                                    let request = await fetch(`${endpoint}/delete-drone-agroforest-kt1`,{
                                                        method:"DELETE",
                                                        headers:{
                                                            "authorization":`Bearer ${globalContext.credentials.token}`,
                                                            "content-type":"application/json"
...
function AssetsImage(props){
    ...
    const fetchImage = async()=>{
        setImageLoading(true);
        let id = props.route.params.id_agroforest_kt1;
        let request = await fetch(`${endpoint}/photo-agroforest-kt1`,{
            method:"POST",
            headers:{
                "authorization":`Bearer ${globalContext.credentials.token}`,
                "content-type":"application/json"
    ...
    useEffect(()=>{
        props.navigation.setOptions({
            headerTitle: `Photo KK1 - ${props.route.params.site_code}`,
        });
    },[])
                        ...
                        onPress={async ()=>{
                            ...
                            if(required){
                                ...
                                if(!gambar.canceled){
                                    ...
                                    // $id_agroforest_kt1 = $request->id_agroforest_kt1;
                                    ...
                                    let req2 = await fetch(`${endpoint}/add-photo-agroforest-kt1`,{
                                        method:"POST",
                                        headers:{
                                            "authorization":`Bearer ${globalContext.credentials.token}`,
                                            "content-type":"application/json"
                                        ...
                                        Alert.alert(
                                            ...
                                            [
                                              ...
                                              { text: "Iya", onPress: async () => {
                                                    ...
                                                    let id = item.id_agroforest_kt1_photo;
                                                    let request = await fetch(`${endpoint}/delete-photo-agroforest-kt1`,{
                                                        method:"DELETE",
                                                        headers:{
                                                            "authorization":`Bearer ${globalContext.credentials.token}`,
                                                            "content-type":"application/json"
...
export default function AssetsKK1Screen(props){
