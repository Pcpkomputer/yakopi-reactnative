...
export default function InputComunnityGroupOfflineScreen(props){
    ...
    const [communityGroup,setCommunityGroup] = useState(globalContext.communityGroup);
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   if(check){   
                        ...
                        if(communityGroup){
                            setSmokeScreenOpened(false);
                            setCommunityGroup([...communityGroup,...payloadArray]);
                            AsyncStorage.setItem("communityGroup",JSON.stringify([...communityGroup,...payloadArray]));
                            alert('Berhasil menyimpan data ke local');
                            props.navigation.navigate("ListCommunityGroupOffline");
                        }else{
                            setCommunityGroup(payloadArray);
                            AsyncStorage.setItem("communityGroup",JSON.stringify(payloadArray));
                            setSmokeScreenOpened(false);
                            alert('Berhasil menyimpan data ke local');
                            props.navigation.navigate("ListCommunityGroupOffline");
                        }
