...
export default function ListCommunityRegisterOfflineScreen(props){
    ...
    let fetchList = async () => {
        ...
        let list = await AsyncStorage.getItem("comdev");
    ...
    return (
        <View style={{ flex: 1 }}>
          <TouchableOpacity
            activeOpacity={0.6}
            onPress={() => {
              props.navigation.navigate("InputComunnityOffline");
            }}
            style={{
              position: "absolute",
              zIndex: 9999,
                                    ...
                                    Alert.alert(
                                        ...
                                        [
                                            ...
                                            { text: "Iya", onPress: async () => {
                                                ...
                                                list.splice(index,1);
                                                await AsyncStorage.setItem("comdev",JSON.stringify(list));
