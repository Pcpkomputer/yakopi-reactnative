...
export default function InputSilvosheryOfflineScreen(props){
    ...
    const [silvoshery, setSilvoshery] = useState(globalContext.silvoshery);
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   if(check){   
                        ...
                        if(silvoshery){
                            setSmokeScreenOpened(false);
                            setSilvoshery([...silvoshery,...payloadArray]);
                            AsyncStorage.setItem("silvoshery",JSON.stringify([...silvoshery,...payloadArray]));
                            alert('Berhasil menyimpan data ke local');
                            props.navigation.navigate("ListSilvosheryOffline");
                        }else{
                            setSilvoshery(payloadArray);
                            AsyncStorage.setItem("silvoshery",JSON.stringify(payloadArray));
                            setSmokeScreenOpened(false);
                            alert('Berhasil menyimpan data ke local');
                            props.navigation.navigate("ListSilvosheryOffline");
                        }
