...
export default function ListCommunityGroupOfflineScreen(props){
    ...
    let fetchList = async () => {
        ...
        let list = await AsyncStorage.getItem("communityGroup");
    ...
    return (
        <View style={{ flex: 1 }}>
          <TouchableOpacity
            activeOpacity={0.6}
            onPress={() => {
              props.navigation.navigate("InputComunnityGroupOffline");
            }}
            style={{
              position: "absolute",
              zIndex: 9999,
                            ...
                            style={{flexDirection:"row",marginHorizontal:EStyleSheet.value("20rem"),borderRadius:EStyleSheet.value("5rem")}}>
                                ...
                                <View style={{flexDirection:"column",flex:1}}>
                                    ...
                                    <ScrollView showsHorizontalScrollIndicator={false} horizontal={true} style={{paddingHorizontal:EStyleSheet.value("10rem"),flexDirection:"row"}}>
                                        ...
                                        <Text style={{fontSize:EStyleSheet.value("11rem"),color:"white"}}>{item.nama_pj}</Text>
                                        </View>
                                            ...
                                            Alert.alert(
                                                ...
                                                [
                                                    ...
                                                    { text: "Iya", onPress: async () => {
                                                        ...
                                                        list.splice(index,1);
                                                        await AsyncStorage.setItem("communityGroup",JSON.stringify(list));
