...
export default function InputDetailPlotBoundaringScreen(props){
    ...
    const [schema, setSchema] = useState([
        {
            form:"id_plot_boundaring",
            value:props.route.params.id_plot_boundaring,
        },
        {
            type:"textinput",
            label:"Site Code",
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   if(check){   
                        ...
                        console.log(payload);
                        let request = await fetch(`${endpoint}/add-kind-plot-boundering`,{
                            method:"POST",
                            headers:{
