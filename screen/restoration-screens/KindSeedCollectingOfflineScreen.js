...
export default function KindSeedCollectingOffline(props){
    ...
    const [KT2Kind, setKT2Kind] = useState(globalContext.KT2Kind);
    const id_collecting_seed = props.route.params.id_collecting_seed;
    ...
    let fetchList = async () =>{
        setListLoading(true);
        let list = await AsyncStorage.getItem("KT2Kind");
        console.log(list);
        ...
        list = list.filter((item)=>{
            return item.id === id_collecting_seed;
        })
        setList(list);
    ...
    return (
      <View style={{flex:1, backgroundColor:'#fff'}}>
        <TouchableOpacity 
            activeOpacity={0.6}
            onPress={()=>{
                props.navigation.navigate("InputDetailSeedCollectingOffline",{ id_collecting_seed:props.route.params.id_collecting_seed });
            }}
                      ...
                      [
                          ...
                          { 
                              ...
                              onPress: async () => {
                                  ...
                                  list.splice(index, 1);
                                  await AsyncStorage.setItem("KT2Kind", JSON.stringify(list));
