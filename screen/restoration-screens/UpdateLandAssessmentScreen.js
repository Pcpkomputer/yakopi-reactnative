...
export default function UpdateLandAssessmentScreen(props){
    ...
    const [schema, setSchema] = useState([
        ...
        },
        {
            ...
            value:props.route.params.item.area_land_assessment.toString() || "",
        ...
        },
        {
            ...
            label:"Posisi Site",
            value:{
                id:props.route.params.item.posisi_site,
        ...
        },
        {
            ...
            value:{
                id:props.route.params.item.sejarah_lokasi,
        ...
        },
        {
            ...
            label:"Akses jalan",
            value:{
                id:props.route.params.item.akses_jalan,
        ...
        },
        {
            ...
            label:"Kondisi lahan",
            value:{
                id:props.route.params.item.kondisi_lahan,
        ...
        },
        {
            ...
            label:"Adanya perdu",
            value:{
                id:props.route.params.item.adanya_perdu,
        ...
        },
        {
            ...
            value:{
                id:props.route.params.item.potensi_gangguan_hewan_peliharaan,
        ...
        },
        {
            ...
            label:"Potensi hama",
            value:{
                id:props.route.params.item.potensi_hama,
        ...
        },
        {
            ...
            value:{
                id:props.route.params.item.potensi_gangguan_tritip,
        ...
        },
        {
            ...
            value:{
                id:props.route.params.item.potensi_gangguan_kepiting,
        ...
        },
        {
            ...
            value:{
                id:props.route.params.item.potensi_gempuran_ombak,
        ...
        },
        {
            ...
            label:"Jenis tanah",
            value:{
                id:props.route.params.item.jenis_tanah,
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   let check = required.every((item)=>{
                        ...
                        // Route::put("/land-assessment/{id}", function (Request $request, $id){
                        try{
                            let request = await fetch(`${endpoint}/land-assessment/${props.route.params.item.id_land_assessment}`,{
                                method:"PUT",
                                headers:{
                                    "authorization":`Bearer ${globalContext.credentials.token}`,
