...
export default function UpdateNurseryActivityOfflineScreen(props){
    ...
    let fetchList = async () => {
        ...
        let KT3 = KT3[props.route.params.index];
        setKT3(KT3[props.route.params.index]);
        setList(KT3[props.route.params.index]);
    };
    ...
    useEffect(()=>{
        if(focused){
            ...
            fetchProject();
            fetchProvince();
            if (KT3 && KT3.length > 0 && KT3[index]) {
                fetchProjectById(KT3[index].project);
                fetchProvinceById(KT3[index].province);
                fetchCityById(KT3[index].city);
                fetchDistrictById(KT3[index].district);
            }
        }
    },[focused]);
    ...
    const [schema, setSchema] = useState([
        {
            type:"textinput",
            label:"Invoice Code",
            value:KT3[props.route.params.index].invoice_code || "",
            form:"invoice_code",
            required:false
        },
        {
            ...
            label:"Project",
            value:{
                id:KT3[props.route.params.index].id_project,
        ...
        },
        {
            ...
            value:KT3[props.route.params.index].dilaporkan_oleh || "",
        ...
        },
        {
            ...
            label:"Provinsi",
            value:{
                id:KT3[props.route.params.index].id_provinces,
        ...
        },
        {
            ...
            value:{
                id:KT3[props.route.params.index].id_cities,
                value:citySelected || "",
            },
            form:"city",
            required:true
        },
        {
            ...
            label:"Kecamatan",
            value:{
                id:KT3[props.route.params.index].id_districts,
        ...
        },
        {
            type:"textinput",
            label:"Desa",
            value:KT3[props.route.params.index].village || "",
            form:"village",
            required:true
        },
        {
            type:"textinput",
            label:"Dusun",
            value:KT3[props.route.params.index].backwood || "",
            form:"backwood",
            required:true
        },
        {
        ...
        },
        {
            ...
            value:KT3[props.route.params.index].catatan_1 || "",
            form:"catatan_1",
            required:true
        },
        {
            ...
            value:KT3[props.route.params.index].catatan_2 || "",
            form:"catatan_2",
            required:true
        },
    ]);
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   let check = required.every((item)=>{
                        ...
                        // update KT3 local storage and state global yang index nya sesuai dengan index dan update datanya sesuai dengan schema
                        let KT3 = await AsyncStorage.getItem("KT3");
                        KT3 = JSON.parse(KT3);
                        KT3[index] = payload;
                        console.log(KT3,"KT3");
                        setKT3(KT3);
                        await AsyncStorage.setItem("KT3",JSON.stringify(KT3));
                        setSmokeScreenOpened(false);
