...
export default function UpdateLandAssessmentOfflineScreen(props){
    ...
    let fetchList = async () => {
        ...
        let KT1 = KT1[props.route.params.index];
        setKT1(KT1[props.route.params.index]);
        setList(KT1[props.route.params.index]);
    };
    ...
    useEffect(()=>{
        if(focused){
            ...
            fetchProject();
            fetchProvince();
            if (KT1 && KT1.length > 0 && KT1[index]) {
                fetchProjectById(KT1[index].project);
                fetchProvinceById(KT1[index].province);
                fetchCityById(KT1[index].city);
                fetchDistrictById(KT1[index].district);
            }
        }
    },[focused]);
    ...
    const [schema, setSchema] = useState([
         {
            type:"textinput",
            label:"Invoice Code",
            value:KT1[props.route.params.index].invoice_code || "",
            form:"invoice_code",
            required:false
        },
        {
            type:"textinput",
            label:"Kode Site",
            value:KT1[props.route.params.index].site_code || "",
            form:"site_code",
            required:true
        },
        {
            ...
            label:"Project",
            value:{
                id:KT1[props.route.params.index].project ,
        ...
        },
        {
            type:"textinput",
            label:"Surveyor",
            value:KT1[props.route.params.index].surveyor || "",
            form:"surveyor",
            required:true
        },
        {
            type:"dateinput",
            label:"Tanggal",
            value:KT1[props.route.params.index].date_land_assessment || "",
        ...
        },
        {
            ...
            label:"Koordinat",
            value:{
                latitude:KT1[props.route.params.index].coordinate.latitude || "",
                longitude:KT1[props.route.params.index].coordinate.longitude || "",
            },
            form:"coordinate",
            required:true
        },
        ...
        },
        {
            ...
            label:"Provinsi",
            value:{
                id:KT1[props.route.params.index].province,
        ...
        },
        {
            ...
            value:{
                id:KT1[props.route.params.index].city,
                value:citySelected || "",
            },
            form:"city",
            required:true
        },
        {
            ...
            label:"Kecamatan",
            value:{
                id:KT1[props.route.params.index].district ,
        ...
        },
        {
            type:"textinput",
            label:"Desa",
            value:KT1[props.route.params.index].village || "",
            form:"village",
            required:true
        },
        {
            type:"textinput",
            label:"Dusun",
            value:KT1[props.route.params.index].backwood || "",
            form:"backwood",
            required:true
        },
        {
            ...
            value:KT1[props.route.params.index].area_land_assessment || "",
        ...
        },
        {
            ...
            label:"Posisi Site",
            value:{
                id:KT1[props.route.params.index].site_position,
                value:KT1[props.route.params.index].site_position || "",
            },
            form:"site_position",
            required:true
        },
        {
            ...
            value:KT1[props.route.params.index].estimated_number_of_plots_per_site || "",
        ...
        },
        {
            ...
            value:{
                id:KT1[props.route.params.index].history_location,
                value:KT1[props.route.params.index].history_location || "",
            },
        ...
        },
        {
            ...
            label:"Akses jalan",
            value:{
                id:KT1[props.route.params.index].road_access,
                value:KT1[props.route.params.index].road_access || "",
            },
            form:"road_access",
            required:true
        },
        ...
        },
        {
            ...
            label:"Kondisi lahan",
            value:{
                id:KT1[props.route.params.index].land_condition,
                value:KT1[props.route.params.index].land_condition || "",
            },
            form:"land_condition",
            required:true
        },
        {
            ...
            value:KT1[props.route.params.index].the_presence_of_mangrove_stands || "",
        ...
        },
        {
            ...
            label:"Adanya perdu",
            value:{
                id:KT1[props.route.params.index].shrubs,
                value:KT1[props.route.params.index].shrubs || "",
            },
            form:"shrubs",
            required:true
        },
        {
            ...
            value:{
                id:KT1[props.route.params.index].pet_nuisance,
                value:KT1[props.route.params.index].pet_nuisance || "",
            },
            form:"pet_nuisance",
            required:true
        },
        {
            ...
            label:"Potensi hama",
            value:{
                id:KT1[props.route.params.index].pest_potential,
                value:KT1[props.route.params.index].pest_potential || "",
            },
            form:"pest_potential",
            required:true
        },
        {
            ...
            value:{
                id:KT1[props.route.params.index].tritype_disorder_potential,
                value:KT1[props.route.params.index].tritype_disorder_potential || "",
            },
        ...
        },
        {
            ...
            value:{
                id:KT1[props.route.params.index].crab_interference_potential,
                value:KT1[props.route.params.index].crab_interference_potential || "",
            },
        ...
        },
        {
            ...
            value:{
                id:KT1[props.route.params.index].potential_for_waves,
                value:KT1[props.route.params.index].potential_for_waves || "",
            },
        ...
        },
        {
            ...
            label:"Jenis tanah",
            value:{
                id:KT1[props.route.params.index].type_of_soil,
                value:KT1[props.route.params.index].type_of_soil || "",
            },
            form:"type_of_soil",
            required:true
        },
        ...
        },
        {
            ...
            value:KT1[props.route.params.index].important_information_from_group_members || "",
        ...
        },
        {
            ...
            value:KT1[props.route.params.index].other_important_information_from_group_members || "",
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   let check = required.every((item)=>{
                        ...
                        // update KT1 local storage and state global yang index nya sesuai dengan index dan update datanya sesuai dengan schema
                        let KT1 = await AsyncStorage.getItem("KT1");
                        KT1 = JSON.parse(KT1);
                        KT1[index] = payload;
                        console.log(KT1,"KT1");
                        setKT1(KT1);
                        await AsyncStorage.setItem("KT1",JSON.stringify(KT1));
                        setSmokeScreenOpened(false);
