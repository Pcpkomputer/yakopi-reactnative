...
export default function UpdateReplantingScreen(props){
    ...
    let fetchList = async () => {
        ...
        let KT8 = KT8[props.route.params.index];
        setKT8(KT8[props.route.params.index]);
        setList(KT8[props.route.params.index]);
    };
    ...
    useEffect(()=>{
        if(focused){
            ...
            fetchProject();
            fetchProvince();
            if (KT8 && KT8.length > 0 && KT8[index]) {
                fetchProjectById(KT8[index].project);
                fetchProvinceById(KT8[index].province);
                fetchCityById(KT8[index].city);
                fetchDistrictById(KT8[index].district);
            }
        }
    },[focused]);
    ...
    const [schema, setSchema] = useState([
        {
            type:"textinput",
            label:"Invoice Code",
            value:KT8[props.route.params.index].invoice_code,
            form:"invoice_code",
            required:false
        },
        {
            ...
            label:"Project",
            value:{
                id:KT8[props.route.params.index].id_project ,
        ...
        },
        {
            ...
            value:KT8[props.route.params.index].dilaporkan_oleh || "",
        ...
        },
        {
            ...
            label:"Provinsi",
            value:{
                id:KT8[props.route.params.index].id_provinces ,
        ...
        },
        {
            ...
            value:{
                id:KT8[props.route.params.index].id_cities ,
                value:citySelected || "",
            },
            form:"city",
            required:true
        },
        {
            ...
            label:"Kecamatan",
            value:{
                id:KT8[props.route.params.index].id_districts ,
        ...
        },
        {
            type:"textinput",
            label:"Desa",
            value:KT8[props.route.params.index].village || "",
            form:"village",
            required:true
        },
        {
            type:"textinput",
            label:"Dusun",
            value:KT8[props.route.params.index].backwood || "",
            form:"backwood",
            required:true
        },
        {
            ...
            value:KT8[props.route.params.index].jarak_tanam || "",
            form:"jarak_tanam",
            required:true
        },
        {
            ...
            value:{
                id:KT8[props.route.params.index].lokasi_tanam,
                value:KT8[props.route.params.index].lokasi_tanam || "",
            },
            form:"lokasi_tanam",
            required:true
        },
        {
            ...
            value:KT8[props.route.params.index].info_1 || "",
            form:"info_1",
            required:true
        },
        {
        ...
        },
        {
            ...
            value:KT8[props.route.params.index].catatan_1 || "",
            form:"catatan_1",
            required:true
        },
        {
            ...
            value:KT8[props.route.params.index].catatan_2 || "",
            form:"catatan_2",
            required:true
        },
    ]);
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   let check = required.every((item)=>{
                        ...
                        // update KT8 local storage and state global yang index nya sesuai dengan index dan update datanya sesuai dengan schema
                        let KT8 = await AsyncStorage.getItem("KT8");
                        KT8 = JSON.parse(KT8);
                        KT8[index] = payload;
                        console.log(KT8,"KT8");
                        setKT8(KT8);
                        await AsyncStorage.setItem("KT8",JSON.stringify(KT8));
                        setSmokeScreenOpened(false);
