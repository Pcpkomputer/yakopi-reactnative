...
export default function UpdateNurseryActivityScreen(props){
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   let check = required.every((item)=>{
                        ...
                        console.log(payload);
                        try{
                            let request = await fetch(`${endpoint}/nursery-activity/${props.route.params.item.id_nursery_activity}`,{
                                method:"PUT",
                                headers:{
                                    "authorization":`Bearer ${globalContext.credentials.token}`,
