...
export default function UpdateGrowthOfflineScreen(props){
    ...
    let fetchList = async () => {
        ...
        let KT7 = KT7[props.route.params.index];
        setKT7(KT7[props.route.params.index]);
        setList(KT7[props.route.params.index]);
    };
    ...
    useEffect(()=>{
        if(focused){
            ...
            fetchProject();
            fetchProvince();
            if (KT7 && KT7.length > 0 && KT7[index]) {
                fetchProjectById(KT7[index].project);
                fetchProvinceById(KT7[index].province);
                fetchCityById(KT7[index].city);
                fetchDistrictById(KT7[index].district);
            }
        }
    },[focused]);
    ...
    const [schema, setSchema] = useState([
        {
            type:"textinput",
            label:"Invoice Code",
            value:KT7[props.route.params.index].invoice_code,
            form:"invoice_code",
            required:false
        },
        {
            ...
            label:"Project",
            value:{
                id:KT7[props.route.params.index].id_project ,
        ...
        },
        {
            ...
            value:KT7[props.route.params.index].nama_surveyor || "",
            form:"nama_surveyor",
            required:true
        },
        {
        ...
        },
        {
            ...
            label:"Provinsi",
            value:{
                id:KT7[props.route.params.index].id_provinces ,
        ...
        },
        {
            ...
            value:{
                id:KT7[props.route.params.index].id_cities ,
                value:citySelected || "",
            },
            form:"city",
            required:true
        },
        {
            ...
            label:"Kecamatan",
            value:{
                id:KT7[props.route.params.index].id_districts ,
        ...
        },
        {
            type:"textinput",
            label:"Desa",
            value:KT7[props.route.params.index].village || "",
            form:"village",
            required:true
        },
        {
            type:"textinput",
            label:"Dusun",
            value:KT7[props.route.params.index].backwood || "",
            form:"backwood",
            required:true
        },
        {
            ...
            value:{
                id:KT7[props.route.params.index].posisi_site,
                value:KT7[props.route.params.index].posisi_site || "",
            },
            form:"position",
            required:true
        },
        {
            ...
            value:KT7[props.route.params.index].distance_growth || "",
            form:"distance",
            required:true
        },
        {
            ...
            value:KT7[props.route.params.index].type_magrove_growth || "",
            form:"type_magrove",
            required:true
        },
        {
        ...
        },
        {
            ...
            value:KT7[props.route.params.index].catatan_khusus_1 || "",
        ...
        },
        {
            ...
            value:KT7[props.route.params.index].catatan_khusus_2 || "",
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   let check = required.every((item)=>{
                        ...
                        // update KT7 local storage and state global yang index nya sesuai dengan index dan update datanya sesuai dengan schema
                        let KT7 = await AsyncStorage.getItem("KT7");
                        KT7 = JSON.parse(KT7);
                        KT7[index] = payload;
                        console.log(KT7,"KT7");
                        setKT7(KT7);
                        await AsyncStorage.setItem("KT7",JSON.stringify(KT7));
                        setSmokeScreenOpened(false);
