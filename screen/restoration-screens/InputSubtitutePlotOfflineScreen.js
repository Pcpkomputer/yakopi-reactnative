...
export default function InputSubtitutePlotScreen(props){
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   let check = required.every((item)=>{
                        ...
                        if(KT9){
                            setSmokeScreenOpened(false);
                            setKT9([...KT9,...payloadArray]);
                            AsyncStorage.setItem("KT9",JSON.stringify([...KT9,...payloadArray]));
                            alert('Berhasil menyimpan data ke local');
                            props.navigation.navigate("ListSubtitutePlotOffline");
                        }else{
                            setKT9(payloadArray);
                            AsyncStorage.setItem("KT9",JSON.stringify(payloadArray));
                            setSmokeScreenOpened(false);
                            alert('Berhasil menyimpan data ke local');
                            props.navigation.navigate("ListSubtitutePlotOffline");
                        }
