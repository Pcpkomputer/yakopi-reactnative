...
export default function UpdateSeedCollectingOfflineScreen(props){
    ...
    let fetchList = async () => {
        ...
        let KT2 = KT2[props.route.params.index];
        setKT2(KT2[props.route.params.index]);
        setList(KT2[props.route.params.index]);
    };
    ...
    useEffect(()=>{
        if(focused){
            ...
            fetchProject();
            fetchProvince();
            if (KT2 && KT2.length > 0 && KT2[index]) {
                fetchProjectById(KT2[index].project);
                fetchProvinceById(KT2[index].province);
                fetchCityById(KT2[index].city);
                fetchDistrictById(KT2[index].district);
            }
        }
    },[focused]);
    ...
    const [schema, setSchema] = useState([
        {
            type:"textinput",
            label:"Invoice Code",
            value:KT2[props.route.params.index].invoice_code || "", 
            form:"invoice_code",
            required:false
        },
        {
            ...
            label:"Project",
            value:{
                id:KT2[props.route.params.index].id_project,
        ...
        },
        {
            ...
            value:KT2[props.route.params.index].dilaporkan_oleh || "",
        ...
        },
        {
            ...
            label:"Provinsi",
            value:{
                id:KT2[props.route.params.index].id_provinces,
        ...
        },
        {
            ...
            value:{
                id:KT2[props.route.params.index].id_cities,
                value:citySelected || "",
            },
            form:"city",
            required:true
        },
        {
            ...
            label:"Kecamatan",
            value:{
                id:KT2[props.route.params.index].id_districts,
        ...
        },
        {
            type:"textinput",
            label:"Desa",
            value:KT2[props.route.params.index].village || "",
            form:"village",
            required:true
        },
        {
            type:"textinput",
            label:"Dusun",
            value:KT2[props.route.params.index].backwood || "",
            form:"backwood",
            required:true
        },
        {
        ...
        },
        {
            ...
            value:{
                id:KT2[props.route.params.index].transportation_used_1,
                value:KT2[props.route.params.index].transportation_used_1 || "",
            },
        ...
        },
        {
            ...
            value:{
                id:KT2[props.route.params.index].transportation_used_2,
                value:KT2[props.route.params.index].transportation_used_2 || "",
            },
        ...
        },
        {
            ...
            value:KT2[props.route.params.index].important_information_from_group_members || "",
        ...
        },
        {
            ...
            value:KT2[props.route.params.index].other_important_information_from_group_members || "",
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   let check = required.every((item)=>{
                        ...
                        // update KT2 local storage and state global yang index nya sesuai dengan index dan update datanya sesuai dengan schema
                        let KT2 = await AsyncStorage.getItem("KT2");
                        KT2 = JSON.parse(KT2);
                        KT2[index] = payload;
                        console.log(KT2,"KT2");
                        setKT2(KT2);
                        await AsyncStorage.setItem("KT2",JSON.stringify(KT2));
                        setSmokeScreenOpened(false);
