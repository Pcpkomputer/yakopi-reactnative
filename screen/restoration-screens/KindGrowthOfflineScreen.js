...
export default function KindGrowthOfflineScreen(props){
  ...
  let fetchList = async () =>{
      setListLoading(true);
      let list = await AsyncStorage.getItem("KT7Kind");
      console.log(list);
    ...
    return (
      <View style={{flex:1, backgroundColor:'#fff'}}>
        <TouchableOpacity 
            activeOpacity={0.6}
            onPress={()=>{
                props.navigation.navigate("InputDetailGrowthOffline",{ id_growth:props.route.params.id_growth });
            }}
                      ...
                      [
                          ...
                          { 
                              ...
                              onPress: async () => {
                                  ...
                                  list.splice(index, 1);
                                  await AsyncStorage.setItem("KT7Kind", JSON.stringify(list));
