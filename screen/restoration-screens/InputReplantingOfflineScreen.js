...
export default function InputReplantingOfflineScreen(props){
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   let check = required.every((item)=>{
                        ...
                        if(KT8){
                            setSmokeScreenOpened(false);
                            setKT8([...KT8,...payloadArray]);
                            AsyncStorage.setItem("KT8",JSON.stringify([...KT8,...payloadArray]));
                            alert('Berhasil menyimpan data ke local');
                            props.navigation.navigate("ListReplantingOffline");
                        }else{
                            setKT8(payloadArray);
                            AsyncStorage.setItem("KT8",JSON.stringify(payloadArray));
                            setSmokeScreenOpened(false);
                            alert('Berhasil menyimpan data ke local');
                            props.navigation.navigate("ListReplantingOffline");
                        }
