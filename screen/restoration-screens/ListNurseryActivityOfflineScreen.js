...
export default function ListNurseryActivityOfflineScreen(props){
    ...
    return (
        <View style={{ flex: 1 }}>
          <TouchableOpacity
            activeOpacity={0.6}
            onPress={() => {
              props.navigation.navigate("InputNurseryActivityOffline");
            }}
            style={{
              position: "absolute",
              zIndex: 9999,
                     ...
                     list.map((item,index)=>{
                         return (
                            ...
                            <View style={{marginHorizontal:EStyleSheet.value("20rem"),flexDirection:"row",justifyContent:"space-around",padding:EStyleSheet.value("10rem"),backgroundColor:"#DDDDDD"}}>
                                        <TouchableOpacity 
                                        onPress={()=>{
                                            props.navigation.navigate("KindNurseryActivityOffline",{id_nursery_activity:item.id});
                                        }}
