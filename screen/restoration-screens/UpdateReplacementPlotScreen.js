...
export default function UpdateReplacementPlotScreen(props){
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   let check = required.every((item)=>{
                        ...
                        console.log(payload);
                        try{
                            let request = await fetch(`${endpoint}/replacement-plot/${props.route.params.item.id_replacement_plot}`,{
                                method:"PUT",
                                headers:{
                                    "authorization":`Bearer ${globalContext.credentials.token}`,
