...
function AssetsVideo(props){
    ...
    const fetchVideo = async()=>{
        ...
        let request = await fetch(`${endpoint}/video-nursery-activity`,{
            method:"POST",
            headers:{
    ...
    useEffect(()=>{
        props.navigation.setOptions({
            headerTitle: `Video - ${props.route.params.id_nursery_activity}`,
        });
    },[])
                        ...
                        onPress={async ()=>{
                            ...
                            if(required){
                                ...
                                if(gambar.type==="success"){
                                    ...
                                    form.append("file_nursery_activity_video",photo);
                                    let request = await fetch(`https://sispro-yakopi.org/endpoint/dokumentasiVideoNurseryActivity`,{
                                        method:"POST",
                                        body:form
                                    });
                                    let response = await request.json();
                                    ...
                                    let req2 = await fetch(`${endpoint}/add-video-nursery-activity`,{
                                        method:"POST",
                                        headers:{
                                            "authorization":`Bearer ${globalContext.credentials.token}`,
                                            "content-type":"application/json"
                                        ...
                                        body:JSON.stringify({
                                            id_nursery_activity:id,
                                            keterangan_nursery_activity_video:keterangan,
                                            link_nursery_activity_video:"",
                                            file_nursery_activity_video:url
                                        })
                                    });
                        ...
                        return (
                            <View style={{marginHorizontal:EStyleSheet.value("20rem"),overflow:"hidden",borderRadius:EStyleSheet.value("3rem"),marginBottom:EStyleSheet.value("15rem")}}>
                                <View style={{backgroundColor:"#e8e8e8",height:EStyleSheet.value("200rem")}}>
                                    {
                                        (item.link_nursery_activity_video===null || item.link_nursery_activity_video==="") ?
                                        <Video
                                        style={{flex:1}}
                                        source={{
                                        uri: `${endpoint.replace(/api(.?)/g,"")}${item.file_nursery_activity_video}`,
                                        }}
                                        useNativeControls
                                        resizeMode="contain"/>
                                        :
                                        ...
                                        style={{flex:1}}
                                        source={{
                                        uri: item.link_nursery_activity_video,
                                        }}
                                        useNativeControls
                                        resizeMode="contain"/>
                                    }
                                ...
                                <View style={{zIndex:10,paddingHorizontal:EStyleSheet.value("20rem"),paddingVertical:EStyleSheet.value("15rem")}}>
                                    <Text style={{color:"white",fontSize:EStyleSheet.value("20rem")}}>{item.keterangan_nursery_activity_video}</Text>
                                </View>
                                <LinearGradient
...
function AssetsDrone(props){
    ...
    const fetchImage = async()=>{
        setImageLoading(true);
        let id = props.route.params.id_nursery_activity;
        let request = await fetch(`${endpoint}/drone-nursery-activity`,{
            method:"POST",
            headers:{
                "authorization":`Bearer ${globalContext.credentials.token}`,
                "content-type":"application/json"
    ...
    useEffect(()=>{
        props.navigation.setOptions({
            headerTitle: `Drone - ${props.route.params.id_nursery_activity}`,
        });
    },[])
...

{
                        ...
                        onPress={async ()=>{
                            ...
                            if(required){
                                ...
                                if(!gambar.canceled){
                                    ...
                                    form.append("file_nursery_activity_drone",photo);
                                    let request = await fetch(`https://sispro-yakopi.org/endpoint/dokumentasiDroneNurseryActivity`,{
                                        method:"POST",
                                        body:form
                                    });
                                    let response = await request.json();
                
                                    let url = `/assets/img/droneNurseryActivity/${response.result.orig_name}`;

                                    let id = props.route.params.id_nursery_activity;

                                    
                                    let req2 = await fetch(`${endpoint}/add-drone-nursery-activity`,{
                                        method:"POST",
                                        headers:{
                                            "authorization":`Bearer ${globalContext.credentials.token}`,
                                            "content-type":"application/json"
                                        ...
                                        body:JSON.stringify({
                                            id_nursery_activity:id,
                                            keterangan_nursery_activity_drone:keterangan,
                                            link_nursery_activity_drone:"",
                                            file_nursery_activity_drone:url
                                        })
                                    });
                                    let res2 = await req2.json();
...

            {
                ...
                <FlatList
                    ...
                    data={image}
                    renderItem={({item,index})=>{
                        console.log(`${endpoint.replace(/api(.?)/g,"")}${item.file_nursery_activity_drone}`);
                        return (
                            <View style={{marginHorizontal:EStyleSheet.value("20rem"),overflow:"hidden",borderRadius:EStyleSheet.value("3rem"),marginBottom:EStyleSheet.value("15rem")}}>
                                <View style={{backgroundColor:"#e8e8e8",height:EStyleSheet.value("200rem")}}>
                                    {
                                        (item.link_nursery_activity_drone===null || item.link_nursery_activity_drone==="") ?
                                        <Image style={{width:"100%",height:"100%"}} source={{uri:`${endpoint.replace(/api(.?)/g,"")}${item.file_nursery_activity_drone}`}}></Image>
                                        :
                                        <Image style={{width:"100%",height:"100%"}} source={{uri:item.link_nursery_activity_drone}}></Image>
                                    }
                                </View>
                                <View style={{position:"absolute",zIndex:10,bottom:EStyleSheet.value("20rem"),paddingHorizontal:EStyleSheet.value("20rem")}}>
                                    <Text style={{color:"white",fontSize:EStyleSheet.value("20rem")}}>{item.keterangan_nursery_activity_drone}</Text>
                                </View>
                                <LinearGradient
                                style={{position:"absolute",bottom:0,width:"100%",height:"50%"}}
                                colors={['transparent', 'rgba(0,0,0,0.5)']}>
...
function AssetsImage(props){
    ...
    const fetchImage = async()=>{
        setImageLoading(true);
        let id = props.route.params.id_nursery_activity;
        let request = await fetch(`${endpoint}/photo-nursery-activity`,{
            method:"POST",
            headers:{
                "authorization":`Bearer ${globalContext.credentials.token}`,
                "content-type":"application/json"
    ...
    useEffect(()=>{
        props.navigation.setOptions({
            headerTitle: `Photo - ${props.route.params.id_nursery_activity}`,
        });
    },[])
        ...
        <View style={{flex:1}}>
                        ...
                        onPress={async ()=>{
                            ...
                            if(required){
                                ...
                                if(!gambar.canceled){
                                    ...
                                    form.append("file_nursery_activity_photo",photo);
                                    let request = await fetch(`https://sispro-yakopi.org/endpoint/dokumentasiPhotoNurseryActivity`,{
                                        method:"POST",
                                        body:form
                                    });
                                    let response = await request.json();
                
                                    let url = `/assets/img/photoNurseryActivity/${response.result.orig_name}`;

                                    let id = props.route.params.id_nursery_activity;

                                    let req2 = await fetch(`${endpoint}/add-photo-nursery-activity`,{
                                        method:"POST",
                                        headers:{
                                            "authorization":`Bearer ${globalContext.credentials.token}`,
                                            "content-type":"application/json"
                                        ...
                                        body:JSON.stringify({
                                            id_nursery_activity:id,
                                            keterangan_nursery_activity_photo:keterangan,
                                            link_nursery_activity_photo:"",
                                            file_nursery_activity_photo:url
                                        })
                                    });
                                    let res2 = await req2.json();
...

            {
                ...
                <View style={{marginHorizontal:EStyleSheet.value("20rem"),overflow:"hidden",borderRadius:EStyleSheet.value("3rem"),marginBottom:EStyleSheet.value("15rem"),paddingBottom:EStyleSheet.value("15rem"),borderBottomWidth:EStyleSheet.value("1rem"),borderBottomColor:"#e8e8e8",backgroundColor:"white",paddingHorizontal:EStyleSheet.value("20rem"),marginBottom:EStyleSheet.value("15rem"),...shadow}}>
                    ...
                    <Text>- Harus diisi foto jarak jauh</Text>
                    <Text>- Harus diisi foto dengan plang</Text>
                    <Text>- Harus diisi foto permbendengan</Text>
                  </View>
                )}
                contentContainerStyle={{ paddingTop: EStyleSheet.value("15rem") }}
                keyExtractor={(item, index) => `image-${index}`}
                ...
                renderItem={({ item, index }) => {
                        return (
                            <View style={{marginHorizontal:EStyleSheet.value("20rem"),overflow:"hidden",borderRadius:EStyleSheet.value("3rem"),marginBottom:EStyleSheet.value("15rem")}}>
                                <View style={{backgroundColor:"#e8e8e8",height:EStyleSheet.value("200rem")}}>
                                    {
                                        (item.link_nursery_activity_photo===null || item.link_nursery_activity_photo==="") ?
                                        <Image style={{width:"100%",height:"100%"}} source={{uri:`${endpoint.replace(/api(.?)/g,"")}${item.file_nursery_activity_photo}`}}></Image>
                                        :
                                        <Image style={{width:"100%",height:"100%"}} source={{uri:item.link_nursery_activity_photo}}></Image>
                                    }
                                </View>
                                <View style={{position:"absolute",zIndex:10,bottom:EStyleSheet.value("20rem"),paddingHorizontal:EStyleSheet.value("20rem")}}>
                                    <Text style={{color:"white",fontSize:EStyleSheet.value("20rem")}}>{item.keterangan_nursery_activity_photo}</Text>
                                </View>
                                <LinearGradient
                                style={{position:"absolute",bottom:0,width:"100%",height:"50%"}}
                                colors={['transparent', 'rgba(0,0,0,0.5)']}>
...
export default function AssetsNursryActivityScreen(props){
