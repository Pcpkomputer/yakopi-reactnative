...
export default function UpdateTransportOfflineScreen(props){
    ...
    let fetchList = async () => {
        ...
        let KT5 = KT5[props.route.params.index];
        setKT5(KT5[props.route.params.index]);
        setList(KT5[props.route.params.index]);
    };
    ...
    useEffect(()=>{
        if(focused){
            ...
            fetchProject();
            fetchProvince();
            if (KT5 && KT5.length > 0 && KT5[index]) {
                fetchProjectById(KT5[index].project);
                fetchProvinceById(KT5[index].province);
                fetchCityById(KT5[index].city);
                fetchDistrictById(KT5[index].district);
            }
        }
    },[focused]);
    ...
    const [data,setData] = useState({
        ...
        city:[],
        district:[],
        transport_info:["Boat","Car","Motorcycle"].map((item,_)=>{return {id:item,value:item}}),
    });
    ...
    const [schema, setSchema] = useState([
        {
            type:"textinput",
            label:"Invoice Code",
            value:KT5[props.route.params.index].invoice_code,
            form:"invoice_code",
            required:false
        },
        {
            ...
            label:"Project",
            value:{
                id:KT5[props.route.params.index].id_project,
        ...
        },
        {
            ...
            value:KT5[props.route.params.index].dilaporkan_oleh || "",
        ...
        },
        {
            ...
            label:"Koordinat",
            value:{
                latitude:KT2[props.route.params.index].coordinate.latitude || "",
                longitude:KT2[props.route.params.index].coordinate.longitude || "",
            },
            form:"coordinate",
            required:true
        },
        ...
        },
        {
            ...
            label:"Provinsi",
            value:{
                id:KT5[props.route.params.index].id_provinces,
        ...
        },
        {
            ...
            value:{
                id:KT5[props.route.params.index].id_cities,
                value:citySelected || "",
            },
            form:"city",
            required:true
        },
        {
            ...
            label:"Kecamatan",
            value:{
                id:KT5[props.route.params.index].id_districts,
        ...
        },
        {
            type:"textinput",
            label:"Desa",
            value:KT5[props.route.params.index].village || "",
            form:"village",
            required:true
        },
        {
            type:"textinput",
            label:"Dusun",
            value:KT5[props.route.params.index].backwood || "",
            form:"backwood",
            required:true
        },
        {
            ...
            value:{
                id:KT5[props.route.params.index].transport_info,
                value:KT5[props.route.params.index].transport_info || "",
            },
            form:"transport_info",
            required:true
        },
        ...
        },
        {
            type:"textinput",
            label:"Kab/Kota",
            value:KT5[props.route.params.index].daerah_tujuan || "",
            form:"daerah_tujuan",
            required:true
        },
        {
            type:"textinput",
            label:"Kecamatan",
            value:KT5[props.route.params.index].kecamatan || "",
            form:"kecamatan",
            required:true
        },
        {
            type:"textinput",
            label:"Desa",
            value:KT5[props.route.params.index].desa || "",
            form:"desa",
            required:true
        },
        {
            type:"textinput",
            label:"Dusun",
            value:KT5[props.route.params.index].dusun || "",
            form:"dusun",
            required:true
        },
        {
        ...
        },
        {
            ...
            value:KT5[props.route.params.index].catatan_1 || "",
            form:"catatan_1",
            required:true
        },
        {
            ...
            value:KT5[props.route.params.index].catatan_2 || "",
            form:"catatan_2",
            required:true
        },
    ]);
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   let check = required.every((item)=>{
                        ...
                        // update KT5 local storage and state global yang index nya sesuai dengan index dan update datanya sesuai dengan schema
                        let KT5 = await AsyncStorage.getItem("KT5");
                        KT5 = JSON.parse(KT5);
                        KT5[index] = payload;
                        console.log(KT5,"KT5");
                        setKT5(KT5);
                        await AsyncStorage.setItem("KT5",JSON.stringify(KT5));
                        setSmokeScreenOpened(false);
