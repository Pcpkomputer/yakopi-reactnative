...
export default function UpdateSeedCollectingScreen(props){
    ...
    const [schema, setSchema] = useState([
        ...
        },
        {
            ...
            value:{
                id:props.route.params.item.trasportasi_1,
        ...
        },
        {
            ...
            value:{
                id:props.route.params.item.trasportasi_2,
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   console.log(check);
                    ...
                    try{
                        let request = await fetch(`${endpoint}/seed-collecting/${props.route.params.item.id_collecting_seed}`,{
                            method:"PUT",
                            headers:{
                                "authorization":`Bearer ${globalContext.credentials.token}`,
