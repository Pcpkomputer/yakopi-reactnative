...
export default function UpdatePlantingActionScreen(props){
    ...
    const [schema, setSchema] = useState([
        ...
        },
        {
            ...
            value:{
                id:props.route.params.item.transportation,
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   let check = required.every((item)=>{
                        ...
                        console.log(payload);
                        try{
                            let request = await fetch(`${endpoint}/planting-action/${props.route.params.item.id_planting_action}`,{
                                method:"PUT",
                                headers:{
                                    "authorization":`Bearer ${globalContext.credentials.token}`,
