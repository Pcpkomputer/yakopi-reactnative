...
export default function UpdateTransportScreen(props){
    ...
    const [schema, setSchema] = useState([
        ...
        },
        {
            ...
            value:{
                id:"",
                value:props.route.params.item.transport_info || "",
            },
            form:"transport_info",
            required:true
        },
        ...
        },
        {
            type:"textinput",
            label:"Kab/Kota",
            value:props.route.params.item.daerah_tujuan || "",
            form:"daerah_tujuan",
            required:true
        },
        {
            type:"textinput",
            label:"Kecamatan",
            value:props.route.params.item.kecamatan || "",
            form:"kecamatan",
            required:true
        },
        {
            type:"textinput",
            label:"Desa",
            value:props.route.params.item.desa || "",
            form:"desa",
            required:true
        },
        {
            ...
            >
               ...
               onPress={async ()=>{
                   ...
                   let check = required.every((item)=>{
                        ...
                        console.log(payload);
                        try{
                            let request = await fetch(`${endpoint}/transport/${props.route.params.item.id_transport}`,{
                                method:"PUT",
                                headers:{
                                    "authorization":`Bearer ${globalContext.credentials.token}`,
